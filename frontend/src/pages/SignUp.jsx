        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 p-8 transform transition-all duration-500 hover:scale-105">
          ...
          <div className="relative z-10">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-purple-200/80">Join us and start your journey</p>
            </div>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              {/* Name Input */}
              <div className="group">
                <label className="block text-sm font-medium text-purple-200 mb-2 transition-colors duration-200 group-focus-within:text-pink-300">
                  Full Name
                </label>
                <div className="relative">
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder-purple-300/60 focus:outline-none focus:ring-2 focus:ring-purple-400/50 focus:border-transparent transition-all duration-300 backdrop-blur-sm hover:bg-white/15"
                  />
                  <div className="absolute inset-x-0 bottom-0 h-0.5 bg-gradient-to-r from-purple-400 to-pink-400 scale-x-0 transition-transform duration-300 origin-left group-focus-within:scale-x-100"></div>
                </div>
              </div>
              ...
              <div className="group">
                ...
                <div className="relative">
                  <select
                    ...
                    value={formData.role}
                    onChange={handleChange}
                    className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-purple-400/50 focus:border-transparent transition-all duration-300 backdrop-blur-sm hover:bg-white/15 appearance-none cursor-pointer"
                  >
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-r from-purple-600 to-pink-600 translate-y-full transition-transform duration-300 group-hover:translate-y-0"></div>
